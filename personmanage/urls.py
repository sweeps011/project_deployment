...
from app01.views import user,depart,admin,account
...
urlpatterns = [
    ...
    #      部门管理
        ...
        #管理员
         ...
         path('admin/<int:id>/change',admin.admin_change),
         path('admin/change/<int:id>/password',admin.admin_change_password),

         #登录
         path('login/',account.account_login),
         path('login/out',account.account_out)
